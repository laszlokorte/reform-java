...
public class EventedDataSet
{
	...
	{
		void onNameChanged(EventedDataSet picture, Identifier<? extends DataDefinition> dataDefinition);

		void onValueChanged(EventedDataSet picture, Identifier<? extends DataDefinition> dataDefinition);
	}
	...
	public void setNameForId(final Identifier<? extends DataDefinition> id, final Name name)
	{
		_evtPicture.getDataSet().setNameForId(id, name);
	}

	public void setValueForId(final Identifier<? extends DataDefinition> id, final DataValue value)
	{
