...
public final class Vector
{
	 ...
	 * radians.
	 */
	public static double getRotatedX(final double x, final double y, final double angle)
	{
	 ...
	 * radians.
	 */
	public static double getRotatedY(final double x, final double y, final double angle)
	{
			...
			centerBY, final double radiusB, final int index)
	{
		...
		final double a = (radiusA * radiusA - radiusB * radiusB + d * d) / (2 * d);
