...
public final class Calculator
{
	...
	public static Value modulo(final Value lhs, final Value rhs) throws SemanticException
	{
		if (lhs.getType() == Value.Type.String || rhs.getType() == Value.Type.String)
		{
			throw new SemanticException();
		}
		else if (lhs.getType() == Value.Type.Double || rhs.getType() == Value.Type.Double)
		{
	...
	public static Value subtract(final Value lhs, final Value rhs) throws SemanticException
	{
		if (lhs.getType() == Value.Type.String || rhs.getType() == Value.Type.String)
		{
			throw new SemanticException();
	...
	public static Value divide(final Value lhs, final Value rhs) throws SemanticException
	{
		if (lhs.getType() == Value.Type.String || rhs.getType() == Value.Type.String)
		{
			throw new SemanticException();
	...
	public static Value multiply(final Value lhs, final Value rhs) throws SemanticException
	{
		if (lhs.getType() == Value.Type.String && rhs.getType() == Value.Type.Integer)
		{
			return new Value(ZERO.matcher(String.format("%0" + rhs.getInteger() + "d", 0)).replaceAll(lhs.getString
					()));
		}
		else if (lhs.getType() == Value.Type.Integer && rhs.getType() == Value.Type.String)
		{
