...
public class ExponentialExpression extends BinaryExpressionBase implements Expression
{
	...
	{
		final boolean leftParen = !(_lhs instanceof ReferenceExpression) && !(_lhs instanceof ConstantExpression);
		final boolean rightParen = !(_rhs instanceof ReferenceExpression) && !(_rhs instanceof ConstantExpression);
		final String op = " ^ ";
