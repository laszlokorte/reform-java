...
public final class Calculator
{
	...
	public static Value multiply(final Value lhs, final Value rhs)
	{
		...
		else if (lhs.type == Value.Type.String && rhs.type == Value.Type.Integer)
		{
			...
			return new Value(ZERO.matcher(
					String.format("%0" + rhs.getInteger() + "d", 0)).replaceAll(
					lhs.getString()));
		}
		else if (lhs.type == Value.Type.Integer && rhs.type == Value.Type.String)
		{
			...
			return new Value(ZERO.matcher(
					String.format("%0" + lhs.getInteger() + "d", 0)).replaceAll(
					rhs.getString()));
		}
	...
	public enum Function
	{
		...
		Argb(4)
				{
					Value apply(final Value a, final Value r, final Value g, final
					Value b)
					{
						return new Value(r.getDouble(), g.getDouble(), b.getDouble(),
						                 a.getDouble());
					}
				},
