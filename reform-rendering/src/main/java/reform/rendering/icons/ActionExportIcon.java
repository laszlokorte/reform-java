...
public class ActionExportIcon implements Icon {
	...
	public ActionExportIcon() {
		...
		_shape.subtract(
				new Area(new Ellipse2D.Double(-400, -1050, 1000, 1000)));
		_shape.subtract(new Area(new Rectangle.Double(100, -400, 500, 700)));

		final Area tip = new Area(t.createTransformedShape(
				new Rectangle2D.Double(-250, -250, 500, 500)));
		tip.subtract(new Area(new Rectangle2D.Double(-400, -400, 400, 800)));

		_shape.add(tip.createTransformedArea(
				AffineTransform.getTranslateInstance(100, 60)));
	}
