...
public class ToolTipRenderer
{
	...
	public void render(final Graphics2D g2, double x, double y, final String text, final
	Color color)
	{
		x = (int) (x / 6) * 6;
		y = (int) (y / 6) * 6;
	...
	public void renderCentered(final Graphics2D g2, double x, double y, final String
			text, final Color color)
	{
		...
		g2.setColor(_background);
		g2.setFont(_font);
		g2.fillRoundRect((int) x + _offset.x - width / 2, (int) y + _offset.y, width, 30,
		                 6, 6);
		g2.setColor(color);
		g2.drawString(text, (int) x + _offset.x + 10 - width / 2,
		              (int) y + _offset.y + 20);
	}
}
