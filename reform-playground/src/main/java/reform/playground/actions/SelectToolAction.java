...
public class SelectToolAction extends AbstractAction implements
ToolControllerListener {
	private static final long serialVersionUID = 1L;

	private final ToolController _toolController;
	private final Tool _tool;

	public SelectToolAction(final ToolController toolController,
			final Tool tool, final String name) {
