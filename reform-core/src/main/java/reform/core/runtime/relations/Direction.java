...
public interface Direction
{
	...
	double getAdjustedXForRuntime(Runtime runtime, double anchorX, double anchorY, double x, double y);

	double getAdjustedYForRuntime(Runtime runtime, double anchorX, double anchorY, double x, double y);
