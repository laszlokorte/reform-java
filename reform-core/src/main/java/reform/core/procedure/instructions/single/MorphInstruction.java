...
public class MorphInstruction extends BaseInstruction {
	...
	public MorphInstruction(final Identifier<? extends Form> formId,
			final Identifier<? extends Anchor> anchorId,
	...
	public void analyze(final Analyzer analyzer) {
		...
		analyzer.publish(this, "Move " + formName + "'s " + anchorName + " "
				+ _distance.getDescription(analyzer));
	}
